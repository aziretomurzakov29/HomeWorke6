public class Main {
    public static void main(String[] args) {
        ...
        Weapon StathamWeapon = new Weapon(TypeOfWeapon.FIREARMS, NameOfWeapon.RIFLE);
        ...
        System.out.println(StathamWeapon.info());
        System.out.println("--------------------------");

        Skeleton Bob = new Skeleton(200, 15, 50);
        Weapon SkeletWeapon = new Weapon(TypeOfWeapon.THROWING, NameOfWeapon.BOW);
        System.out.println(Bob.info());
        System.out.println(SkeletWeapon.info());
        System.out.println("--------------------------");
